...
declare module '@react-navigation/core' {
    ...
    export type NavigationScreenComponent<Options,
        NavigationScreenPropType> = React.ComponentType<any> & {
    ...
    export type NavigationNavigator<Options,
        NavigationPropType> =
    ...
    export type NavigationSwitchProp<State = NavigationRoute,
        Params = NavigationParams> = NavigationScreenProp<State, Params> & {
        jumpTo(routeName: string, key?: string): void;
    };

    export type NavigationSwitchScreenProps<Params = NavigationParams,
        ScreenProps = unknown> = {
        theme: SupportedThemes;
    ...
    export type NavigationSwitchScreenComponent<Params = NavigationParams,
        ScreenProps = unknown> =
    ...
    export type NavigationRouteConfig<Options, NavigationScreenPropType> =
        ...
        | {
        getScreen(): NavigationScreenComponent<Options,
            NavigationScreenPropType>;
    }) & {
        navigationOptions?: NavigationScreenConfig<Options,
            NavigationScreenPropType>;
    ...
    // @ts-ignore
    export interface NavigationNavigatorProps<Options = {},
        State = {},
        ScreenProps = unknown> {
    ...
    // @ts-ignore
    export interface NavigationContainerProps<State = {},
        Options = {},
        ScreenProps = unknown> {
    ...
    export type NavigationView<Options,
        State,
        ScreenProps = unknown> = React.ComponentType<{
        descriptors: { [key: string]: NavigationDescriptor };
        navigationConfig: Options;
        screenProps?: ScreenProps;
    } & NavigationInjectedProps>;

    export type CreateNavigatorConfig<NavigatorConfig,
        RouterConfig,
        Options,
        NavigationScreenPropType> = NavigatorConfig &
        RouterConfig & {
        defaultNavigationOptions?: NavigationScreenConfig<Options,
            NavigationScreenPropType>;
        navigationOptions?: NavigationScreenConfig<{ [key: string]: any },
